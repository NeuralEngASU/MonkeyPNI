...
Process = WScript.Arguments.Item(1) 'PID or name of process to stop (i.e. 8159 or FingerPress.exe)
...
If colProcessList.Count = 0 Then
    Wscript.Echo Process & " could not be found"
Else
    For Each objProcess in colProcessList
        objProcess.Terminate()        
    Next
    Wscript.Echo Process & " was stopped successfully"
End If